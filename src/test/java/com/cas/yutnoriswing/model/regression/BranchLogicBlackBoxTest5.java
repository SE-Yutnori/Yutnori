...
@DisplayName("윷놀이 분기 로직 Black Box 테스트 - 5각형")
class BranchLogicBlackBoxTest5 {
    ...
    void setUp() {
        ...
        //5각형 게임 상태 초기화
        gameState = new GameState(5, 2.0f, playerNames, tokenCounts);
        //플레이어 설정
    ...
    @Test
    @DisplayName("5각형: Edge0-5 분기점을 끼고 3칸 이동")
    ...
    @Test
    @DisplayName("5각형: Edge1-5 분기점을 끼고 3칸 이동")
    ...
    @Test
    @DisplayName("5각형: Edge2-5 분기점을 끼고 3칸 이동")
    ...
    @Test
    @DisplayName("5각형: Edge3-5 분기점을 끼고 3칸 이동")
    ...
    @Test
    @DisplayName("5각형: 센터에서 나가는 분기 (ToCenter1 → ToCenter4)")
    void testCenterPath_ToCenter1() {
        ...
        // Then: ToCenter4-1에 도착해야 함 (실제 결과)
        BoardNode finalPos = tokenManager.getTokenPosition(token);
        assertEquals("ToCenter4-1", finalPos.getName());
    }

    @Test
    @DisplayName("5각형: 센터에서 나가는 분기 (ToCenter2 → ToCenter4)")
    ...
    @Test
    @DisplayName("5각형: 센터에서 나가는 분기 (ToCenter3 → ToCenter4)")
